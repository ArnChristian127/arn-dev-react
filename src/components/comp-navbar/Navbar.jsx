            ...
            <nav className="py-3 px-4 bg-blue-950 text-white fixed top-0 w-full z-50">
                <div className="container mx-auto flex justify-between items-center">
                    ...
                    <div className="flex hidden lg:flex">
                        <a className="flex items-center bg-gradient-to-r from-blue-500 to-sky-800 px-4 py-2 font-bold text-lg rounded-lg gap-2" href="https://github.com/ArnChristian127">
                            Github Profile
                ...
                <nav className="px-4 py-3 bg-blue-950 text-white lg:hidden fixed top-14 z-40 w-full slide-down">
                    <div className="container mx-auto flex flex-col mx-auto">
                        ...
                        <div className="flex mt-3">
                            <a className="flex items-center bg-gradient-to-r from-blue-500 to-blue-800 px-4 py-2 font-bold text-md rounded-lg gap-2" href="https://github.com/ArnChristian127">
                                Github Profile
